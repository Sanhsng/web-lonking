...
export const metadata: Metadata = {
  title: "Điều khoản sử dụng | Lovol Việt Nam",
  description: "Điều khoản sử dụng website Lovol Việt Nam.",
};
    ...
    <main className="pt-32 pb-16 md:pt-40 md:pb-24 bg-surface min-h-[70vh]">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-on-surface-variant font-body-lg leading-relaxed">
          <p>Bằng việc truy cập và sử dụng website Lovol Việt Nam, bạn đồng ý với các điều khoản sau:</p>
          <h3>1. Quyền sở hữu trí tuệ</h3>
          <p>Mọi nội dung, hình ảnh, bài viết trên website này thuộc sở hữu của Lovol Việt Nam hoặc được cấp phép hợp lệ. Việc sao chép mà không có sự đồng ý bằng văn bản là vi phạm pháp luật.</p>
          ...
          <p>Lovol Việt Nam có quyền thay đổi các điều khoản sử dụng này bất cứ lúc nào để phù hợp với quy định mới.</p>
        </div>
      </div>
    </main>
  );
