...
export const metadata: Metadata = {
  title: "Câu hỏi thường gặp | Lonking Việt Nam",
  description: "Các câu hỏi thường gặp khi mua máy công trình Lonking.",
};
    ...
    <main className="pt-32 pb-16 md:pt-40 md:pb-24 bg-surface min-h-[70vh]">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-on-surface-variant font-body-lg leading-relaxed">
          <h3>1. Máy xúc lật Lonking xuất xứ từ đâu?</h3>
          <p>Lonking là thương hiệu thiết bị thi công xây dựng hàng đầu thế giới đến từ Trung Quốc. Mọi sản phẩm tại Việt Nam đều được nhập khẩu nguyên chiếc và phân phối chính hãng.</p>
          <h3>2. Tôi có thể mua phụ tùng thay thế ở đâu?</h3>
          <p>Lonking Việt Nam có các kho phụ tùng lớn tại Hà Nội và Đồng Nai, cam kết cung cấp phụ tùng chính hãng nhanh chóng để không làm gián đoạn công việc của bạn.</p>
