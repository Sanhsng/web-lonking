...
export const metadata: Metadata = {
  title: "Chính sách bảo mật | Lovol Việt Nam",
  description: "Chính sách bảo mật thông tin của Lovol Việt Nam.",
};
    ...
    <main className="pt-32 pb-16 md:pt-40 md:pb-24 bg-surface min-h-[70vh]">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-on-surface-variant font-body-lg leading-relaxed">
          <p>Lovol Việt Nam cam kết bảo vệ thông tin cá nhân của khách hàng một cách tốt nhất.</p>
          ...
          <p>Thông tin của khách hàng chỉ được sử dụng nội bộ trong hệ thống của Lovol Việt Nam. Chúng tôi cam kết không bán, chia sẻ hay trao đổi thông tin này cho bất kỳ bên thứ ba nào khác.</p>
